...
class SalesData:
    ...
    def get_database_info(self: "SalesData") -> str:
        ...
        for table_name in self._get_table_names():
            columns_names = self._get_column_info(table_name)
            table_dicts.append(
        ...
        reporting_years = self._get_reporting_years()
    ...
    def fetch_sales_data_using_sqlite_query(self: "SalesData", sqlite_query: str) -> str:
        """
