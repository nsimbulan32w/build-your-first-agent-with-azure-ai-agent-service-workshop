...
class Utilities:
    ...
    def upload_file(self, project_client: AIProjectClient, file_path: Path, purpose: str = "assistants") -> None:
        """Upload a file to the project."""
        self.log_msg_purple(f"Uploading file: {file_path}")
        file_info = project_client.agents.upload_file(file_path=file_path, purpose=purpose)
    ...
    def create_vector_store(
        ...
        for file in files:
            ...
            file_info = self.upload_file(project_client, file_path=file_path, purpose="assistants")
